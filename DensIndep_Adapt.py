...
@author: frederik
Same as adapt14 but with density independent dispersal
'''
...
class Individual:
    ...
    def resource_use(self,localhabitat,R):
        ...
        Wij=Gamma*math.exp(-(math.pow((self.muT-localhabitat),2)/math.pow((self.varT),2)))  #Wij, match between habitat and niche, 3.2
        Alpha_ij=self.amax*Wij   #Wij is match between habitat and niche 
