...
def LH_dispersal(initialthreshold, rep, cost = 0):
    ...
    if not os.path.exists(default_path + '/hpcdata/dd_data/dispersal/'+ str(directed) + '/'+ str(cost) + '/'+ str(initialthreshold)):
        os.makedirs(default_path + '/hpcdata/dd_data/dispersal/'+ str(directed) + '/'+ str(cost) + '/'+ str(initialthreshold))
    np.save(default_path + '/hpcdata/dd_data/dispersal/'+ str(directed) + '/'+ str(cost) + '/'+ str(initialthreshold) + '/rep'+ str(rep), data)
...
for disp in np.arange(0.25, 5.25, 0.25):
    for rep in range(30):
